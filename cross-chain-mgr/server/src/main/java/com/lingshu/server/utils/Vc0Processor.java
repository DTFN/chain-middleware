...
import com.lingshu.server.dto.VerifiableCredentialDto;
...
//            "    \"UniversityDegreeCredential\"\n" +
     ...
     * @return 标准化VC字符串（无缩进、无换行）
     */
    public static VerifiableCredentialDto fillAndStandardizeVc(
            String chainRid,
            String contractAddress,
            String contractFunc,
            String contractType,
        ...
        // 填充标准化VC
        VerifiableCredentialDto verifiableCredentialDto = new VerifiableCredentialDto();
        verifiableCredentialDto
                .setContext(Arrays.asList("https://www.w3.org/2018/credentials/v1"))
                .setCredentialSubject(
                        new VerifiableCredentialDto.CredentialSubject()
                                .setChainRid(chainRid)
                                .setContractAddress(contractAddress)
                                .setContractFunc(contractFunc)
                ...
                .setIssuer(null)
                .setProof(null)
                .setType(Arrays.asList("VerifiableCredential", "CrossChainContractCallCredential"))
        ;
