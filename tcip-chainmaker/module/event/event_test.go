...
func initTest() {
	...
	event = &common.CrossChainEvent{
		...
		Timeout:                 1000,
		CrossType:               1,
		ChainmakerEventDataType: []common.EventDataType{common.EventDataType_STRING, common.EventDataType_STRING, common.EventDataType_STRING},
...
func Test_BuildCrossChainMsg(t *testing.T) {
	...
	event.ChainmakerEventDataType[0] = common.EventDataType(100)
	req, err = EventManagerV1.BuildCrossChainMsg(eventInfo)
	assert.Nil(t, req)
	assert.Nil(t, err)
...
ContractExtraData:${ContractExtraData};
*/
func Test_BuildBeginCrossChainRequestFromTbis(t *testing.T) {
	initTest()
	eventData := &EventInfo{
		Topic:        "test",
		ChainRid:     "testChainRid",
		ContractName: "testContractName",
		TxProve:      "testTxProve",
		Data: []string{
			"CrossID:172dd23a0534c16cca983902cc134c3624d8756d39424fa1a5fcea511a58c509_7;EventName:cross_save;Business:cross_save;CommitContractName:cm2cm1,CommitContractVersion:...,CommitContractMethod:invoke_contract,CommitContractParamsFormat:eyJzdWJfcmVzdWx0cyI6IiVzIiwibWV0aG9kIjoiJXMifQ==,CommitContractParams:Y29tbWl0,CommitIdentity:...;ChainRID:chainmaker002,Identity:...,ContractName:cm2cm2,ContractVersion:...,ContractMethod:invoke_contract,ContractParamsFormat:eyJtZXRob2QiOiIlcyIsImtleV92YWx1ZXMiOiIlcyIsImNyb3NzX2lkIjoiJXMiLCJ0aW1lIjoiJXMifQ==,ContractParams:c2F2ZV9iYXRjaA==@e1widGVzdDF0bzJrZXlcIjpcIjEwMDAwMFwifQ==@MTcyZGQyM2EwNTM0YzE2Y2NhOTgzOTAyY2MxMzRjMzYyNGQ4NzU2ZDM5NDI0ZmExYTVmY2VhNTExYTU4YzUwOV83@OTg3NjU0MzIx;",
		},
		Tx:          []byte("1234567890"),
		TxId:        "testTxid",
		BlockHeight: 10,
	...
	req, err := BuildBeginCrossChainRequestFromTbis(eventInfo, eventData, EventManagerV1.log, "1")
	assert.NotNil(t, req)
	assert.Nil(t, err)
}
