...
var (
	...
	tx = chainmakerCommon.TransactionInfo{
		Transaction: &chainmakerCommon.Transaction{
			Payload: &chainmakerCommon.Payload{
				TxId: "1234567890",
			},
		},
		BlockHeight: 10,
...
func testInit() {
	...
	chainConfigByte, _ := proto.Marshal(&common.FabricConfig{
		ChainRid: "chain1",
	})
