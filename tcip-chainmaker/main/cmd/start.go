...
import (
	...
	"chainmaker.org/chainmaker/tcip-chainmaker/v2/module/rpcserver"
	"chainmaker.org/chainmaker/tcip-chainmaker/v2/module/server"
...
func StartCMD() *cobra.Command {
	startCmd := &cobra.Command{
		Use:   "start",
		Short: "Startup tcip-chainmaker",
		Long:  "Startup tcip-chainmaker",
