 ...
 * the License.
 */
package com.lingshu.bsp.front.base.properties;
...
public class Constants {
    ...
    public static final String SIGNER_URI = "http://%s/signer/sign";
    public static final String SIGNER_USER_URI =
            "http://%s/signer/user/newUser?encryptType=%s&signUserId=%s&appId=%s&returnPrivateKey=%s";
    public static final String SIGNER_USER_INFO_URI =
            "http://%s/signer/user/%s/userInfo?returnPrivateKey=%s";
    public static final String SIGNER_VERSION_URI =
        "http://%s/signer/version";
    public static final String ACCOUNT1_PATH = "node.key";
    public static final String OPERATE_LEDGER_START = "start";
    public static final String OPERATE_LEDGER_STOP = "stop";
    public static final String OPERATE_LEDGER_REMOVE = "remove";
    public static final String OPERATE_LEDGER_RECOVER = "recover";
    public static final String OPERATE_LEDGER_GET_STATUS = "getStatus";
    ...
    private String nodePath = "/lingshuchain/nodes/127.0.0.1/node0";
