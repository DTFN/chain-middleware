 ...
 * the License.
 */
package com.lingshu.bsp.front.base.code;
...
public class ConstantCode {
    ...
    /* paramaters check */
    public static final RetCode PARAM_FAIL_LEDGER_ID_IS_EMPTY =  RetCode.mark(201001, "ledgerId cannot be empty");
    public static final String PARAM_FAIL_LEDGER_ID_IS_EMPTY_STRING = "{\"code\":201001,\"message\":\"ledgerId cannot be empty\"}";
...
//    public static final RetCode GET_NODE_CONFIG_FAILE = RetCode.mark(201017, "failed to get node config");
    ...
    public static final RetCode LEDGER_ID_NOT_EXIST = RetCode.mark(201034, "ledgerId not exist");
    ...
    public static final RetCode INVALID_LEDGER_OPERATE_TYPE = RetCode.mark(201043, "invalid ledger operate type");
    // freeze contract
    ...
    public static final RetCode CERT_ERROR = RetCode.mark(201047, "cert handle error");
    ...
    public static final RetCode SYSTEM_ERROR_RPC_NULL = RetCode.mark(101003, "rpc instance of ledgerId is null, please try again");
    public static final RetCode SYSTEM_ERROR_LEDGER_LIST_EMPTY = RetCode.mark(101004, "No ledger belongs to this ledgerId(node not belongs to this ledger)");
    public static final RetCode SYSTEM_ERROR_NODE_INACTIVE = RetCode.mark(101005, "No available node to connect");
    public static final RetCode SYSTEM_ERROR_NO_NODE_IN_LEDGER = RetCode.mark(101005, "No nodes belong to this ledger");
    public static final RetCode RPC_CLIENT_IS_NULL = RetCode.mark(101006, "get rpc client failed!");
    ...
    /* builtin check */
    public static final String PARAM_FAIL_LEDGER_ID__IS_EMPTY = "{\"code\":201101,\"message\":\"ledgerId cannot be empty\"}";
    ...
    // ledger operate error code from sdk
    public static final RetCode LEDGER_OPERATE_FAIL = RetCode.mark(201120, "ledger operate fail");
    public static final RetCode NODE_INTERNAL_ERROR = RetCode.mark(201121, "node internal error");
    public static final RetCode LEDGER_ALREADY_EXISTS = RetCode.mark(201122, "ledger already exists");
    public static final RetCode LEDGER_ALREADY_RUNNING = RetCode.mark(201123, "ledger already running");
    public static final RetCode LEDGER_ALREADY_STOPPED = RetCode.mark(201124, "ledger already stopped");
    public static final RetCode LEDGER_ALREADY_DELETED = RetCode.mark(201125, "ledger already deleted");
    public static final RetCode LEDGER_NOT_FOUND = RetCode.mark(201126, "ledger not found");
    public static final RetCode LEDGER_OPERATE_INVALID_PARAMS = RetCode.mark(201127, "ledger operate param error");
    public static final RetCode PEERS_NOT_CONNECTED = RetCode.mark(201128, "ledger peers not connected");
    public static final RetCode GENESIS_CONF_ALREADY_EXISTS = RetCode.mark(201129, "ledger genesis conf already exists");
    public static final RetCode LEDGER_CONF_ALREADY_EXIST = RetCode.mark(201130, "ledger config.ini already exists");
    public static final RetCode GENESIS_CONF_NOT_FOUND = RetCode.mark(201131, "ledger genesis conf not found");
    public static final RetCode LEDGER_CONF_NOT_FOUND = RetCode.mark(201132, "ledger config.ini not found");
    public static final RetCode LEDGER_IS_STOPPING = RetCode.mark(201133, "ledger is stopping");
    public static final RetCode LEDGER_NOT_DELETED = RetCode.mark(201134, "ledger not deleted");
    ...
    // add in 2.2.10
    public static final RetCode INVALID_VMTYPE = RetCode.mark(201163, "Invalid vmType.");

    public static final RetCode SIGN_EXPIRED = RetCode.mark(201170,"signature is expired");
    public static final RetCode SIGN_VERIFY_FAILED = RetCode.mark(201171,"signature verity failed");
    public static final RetCode SIGN_MISSED = RetCode.mark(201172,"signature field missed");
    public static final RetCode BODY_EMPTY = RetCode.mark(201173,"body is empty");
    ...
    public static final RetCode INVALID_NODE_TYPE = RetCode.mark(201217,"invalid node type: validator, witness, remove ");
    public static final RetCode FAIL_CHANGE_NODE_TYPE = RetCode.mark(201218,"set node consensus type fail, check permission or node's ledger config file");
    // cns
    ...
    /* classify common error of client*/
    // keystore
    public static final RetCode RPC_CREATE_KEY_PAIR_NULL = RetCode.mark(201501, "rpcsdk create key pair fail and return null");
    public static final RetCode RPC_PEM_P12_MANAGER_GET_KEY_PAIR_ERROR = RetCode.mark(201502, "pem/p12 manager get key pair error for input params");
    public static final RetCode RPC_PEM_P12_MANAGER_DEPENDENCY_ERROR = RetCode.mark(201503, "pem/p12 manager get key pair error for bc dependency error");
    ...
    public static final RetCode BUILTIN_COMMON_TRANSFER_JSON_FAIL = RetCode.mark(201524, "builtin common transfer to json fail");

    /* java sdk missing client's retcode */
    public static final RetCode ALREADY_REMOVED_FROM_THE_LEDGER = RetCode.mark(-51103, "The node already has been removed from the ledger");
    public static final RetCode ALREADY_EXISTS_IN_VALIDATOR_LIST = RetCode.mark(-51104, "The node already exists in the validatorList");
    public static final RetCode ALREADY_EXISTS_IN_WITNESS_LIST = RetCode.mark(-51105, "The node already exists in the witnessList");

    /* jni error */
    public static final RetCode TX_JNI_ERROR = RetCode.mark(-52001, "TxJni error");
