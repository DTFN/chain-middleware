...
import (
	...
	"chainmaker.org/chainmaker/tcip-fabric/v2/module/rpcserver"
	"chainmaker.org/chainmaker/tcip-fabric/v2/module/server"
...
func StartCMD() *cobra.Command {
	startCmd := &cobra.Command{
		Use:   "start",
		Short: "Startup tcip-fabric",
		Long:  "Startup tcip-fabric",
