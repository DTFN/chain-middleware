 ...
 */
package com.lingshu.fabric.agent.config.code;
...
public class ConstantCode {
    ...
    public static final RetCode SYSTEM_ERROR_LEDGER_LIST_EMPTY = RetCode.mark(102002, "No ledger belongs to this ledgerId(node not belongs to this ledger)");
    public static final RetCode BSP_VERSION_NOT_MATCH_CHAIN_SUPPORT_VERSION = RetCode.mark(102003, "When bsp is v1.3.2 above(inclusive), LingShuChain node must be v2.4.1 above(inclusive)!");
    public static final RetCode CREATE_CHECK_CODE_FAIL = RetCode.mark(102004, "Create check code fail, please check the log of chain-manager for details");
    ...
    public static final RetCode FRONT_LIST_NOT_FOUNT = RetCode.mark(202002, "not found any front for this ledger");
    ...
    public static final RetCode LEDGER_ID_NULL = RetCode
            .mark(202005, "ledger id cannot be empty");

    public static final RetCode INVALID_LEDGER_ID = RetCode.mark(202006, "invalid ledger id");
    ...
    public static final RetCode FRONT_PORT_NOT_DEPLOY = RetCode.mark(202024, "many times connect ip:port cannot be repeated");
    ...
    public static final RetCode ALERT_MAIL_CONFIG_EMPTY = RetCode.mark(202078, "Alert mail config is null or invalid.");
    ...
    /* dynamic ledger manage */
    public static final RetCode LEDGER_ID_EXISTS = RetCode.mark(202300, "ledger id already exists");
    ...
    public static final RetCode LEDGERS_CONFIG_ERROR = RetCode.mark(202414, "Ledgers config error.");
    ...
    public static final RetCode INSERT_LEDGER_ERROR = RetCode.mark(202417, "Insert new ledger failed.");
    ...
    public static final RetCode INSERT_FRONT_LEDGER_ERROR = RetCode.mark(202421, "Insert new front node ledger failed.");
    ...
    public static final RetCode COPY_LEDGER_FILES_ERROR = RetCode.mark(202441, "Copy original ledger config files error.");
    ...
    public static final RetCode NODE_IN_LEDGER_ERROR = RetCode.mark(202450, "Node still in ledger, remove before deleting.");
    ...
    public static final RetCode NODE_NEED_REMOVE_FROM_LEDGER_ERROR = RetCode.mark(202456, "Node is validator or witness, remove from ledger first.");
    ...
    public static final RetCode TWO_VALIDATOR_IN_LEDGER_AT_LEAST = RetCode.mark(202463, "Ledger need two validators at least.");
    public static final RetCode BSP_SIGN_CONFIG_ERROR = RetCode.mark(202464, "Please check bspSignAddress in application.yml file.");
    public static final RetCode BSP_SIGN_NOT_LOCALHOST_ERROR = RetCode.mark(202465, "bspSignAddress cannot be 127.0.0.1 or localhost in application.yml file");
    ...
    public static final RetCode SAME_HOST_ERROR = RetCode.mark(202468, "Host of chain-manager's ip is already existed.");
    // add in 1.4.3
    ...
    public static final RetCode NS_NAME_CANNOT_EMPTY = RetCode.mark(202503, "ns name cannot be empty.");
    public static final RetCode VERSION_ALREADY_EXISTS = RetCode.mark(202504,"version already exists");
    public static final RetCode CONTRACT_PATH_NO_CHANGE = RetCode.mark(202505, "contract path has no change.");
    ...
    public static final RetCode GENESIS_CONF_NOT_FOUND = RetCode.mark(202514, "ledger genesis conf not found");

    // app integration
    public static final RetCode APPNAME_EXISTS = RetCode.mark(202516, "app name exists");
    public static final RetCode APPNAME_NOT_CORRECT = RetCode.mark(202517, "app name not correct");
    ...
    public static final RetCode NO_PRIVATE_KEY_OF_CONTRACT_MANAGER = RetCode.mark(202542,"No private key of contract manager address in bsp");
    ...
    public static final RetCode CONTRACT_TEMPLATE_NOT_EXIST = RetCode.mark(202545,"The template not exists");

    public static final RetCode LEDGER_NOT_ALLOWED_TO_SEND_TX = RetCode.mark(202546,"The ledger is not allowed to send tx");

    public static final RetCode LEDGER_NOT_ALLOWED_TO_REMOVE_NODE = RetCode.mark(202547,"The ledger is not allowed to remove node");
    public static final RetCode NS_VERSION_WRONG = RetCode.mark(202548,"valid version range is 0.1-9.9");
    public static final RetCode NS_VERSION_ALREADY_USED = RetCode.mark(202549,"version already used");
    public static final RetCode LEDGER_NOT_ALLOWED_TO_ADD_NODE = RetCode.mark(202550,"The ledger is not allowed to add node");

    public static final RetCode NODE_NAME_EXIST = RetCode.mark(202551, "node name exist");
    public static final RetCode NS_NAME_ALREADY_USED = RetCode.mark(202552,"nsName already used");
    public static final RetCode BLOCK_NOT_EXIST = RetCode.mark(202553, "block not exist");
    public static final RetCode TRANSACTION_NOT_EXIST = RetCode.mark(202554, "transaction not exist");
    public static final RetCode NOT_EXPECTED_NOTIFY_RESULT = RetCode.mark(202555, "not expected result");

    public static final RetCode CHAIN_NOT_EXIST = RetCode.mark(202556, "chain not exist");
    public static final RetCode REQUEST_CHAIN_MGR_FAIL = RetCode.mark(202557, "request chain_mgr fail");
    public static final RetCode JOIN_INTO_CHAIN_FAIL = RetCode.mark(202558, "join into chain fail");

    public static final RetCode CHAIN_INVITATION_CAN_NOT_BE_AUDITED = RetCode.mark(202559, "can not audit chain invitation.");
    public static final RetCode CHAIN_INVITATION_GEN_KEY_FAIL = RetCode.mark(202560, "fail to gen key and csr of chain member.");
    public static final RetCode CHAIN_INVITATION_GEN_CERT_FAIL = RetCode.mark(202561, "fail to gen cert of chain member.");
    public static final RetCode CHAIN_INVITATION_MEMBER_NOT_EXIST = RetCode.mark(202562, "the chain member doesn't exist.");
    public static final RetCode CHAIN_INVITATION_NOT_MEMBER = RetCode.mark(202563, "the agency is not one of the chain member.");
    public static final RetCode REASON_REQUIRED_IF_REFUSED = RetCode.mark(202564, "reason required if refused.");
    public static final RetCode NODE_ID_REQUIRED_IF_PASSED = RetCode.mark(202565, "nodeId required if passed.");
    public static final RetCode INVALID_INVITATION_UID = RetCode.mark(202566, "invalid invitation uid.");
    public static final RetCode AUDIT_INTO_LEDGER_FAILED = RetCode.mark(202567, "audit into ledger fail.");
    public static final RetCode NODE_ALREADY_JOINED_LEDGER = RetCode.mark(202568, "the node has joined the ledger.");
    public static final RetCode MEMBER_ALREADY_JOINED_LEDGER = RetCode.mark(202569, "the member has joined the ledger.");
    public static final RetCode INVITATION_INVALID = RetCode.mark(202570, "the invitationCode is invalid.");
    public static final RetCode MEMBER_ALREADY_JOINED_CHAIN = RetCode.mark(202571, "the member has joined the chain.");
    public static final RetCode OPT_ONLY_FOR_MASTER = RetCode.mark(202572, "this operation is only allowed for chain master.");
    public static final RetCode OPT_ONLY_FOR_MEMBER = RetCode.mark(202573, "this operation is only allowed for chain member.");
    public static final RetCode INVALID_DEPLOY_MODE = RetCode.mark(202574, "invalid deploy mode.");
    public static final RetCode IO_EXCEPTION = RetCode.mark(202575, "io exception");
    public static final RetCode CHAIN_INVITATION_NOT_EXIST = RetCode.mark(202576, "chain invitation not exist");
    public static final RetCode IS_NOT_INVITER = RetCode.mark(202577, "I'm not the inviter");
    public static final RetCode ADD_VALIDATOR_FAILED = RetCode.mark(202578, "addValidator failed");
    public static final RetCode CANNOT_FIND_LEDGER_MEMBER = RetCode.mark(202579, "cannot find ledger member");
    public static final RetCode INVALID_INVITATION_STATUS = RetCode.mark(202580, "invalid invitation status.");

    public static final RetCode NOTIFY_FAILED = RetCode.mark(202581, "notify failed");
    public static final RetCode DELETE_APP_FAILED = RetCode.mark(202582, "delete app failed");
    public static final RetCode NOT_FIND_APP = RetCode.mark(202583, "not find app");
    public static final RetCode APP_REGISTERED = RetCode.mark(202584, "app has been registered");
    public static final RetCode APP_ONLY_ONE = RetCode.mark(202585, "Only one app can be created");
    public static final RetCode APP_LINK_FORMAT_INVALID = RetCode.mark(202586, "app link format invalid");
    public static final RetCode MEMBER_NOT_REMOVED = RetCode.mark(202587, "there are some members on the chain.");
    public static final RetCode NODE_CONNECT_PEERS_TIMEOUT = RetCode.mark(202588, "the node has not connected with other peers.please try it later.");
    public static final RetCode LEDGER_IN_MODIFY = RetCode.mark(202589, "the ledger is being modified, please try it later.");
    public static final RetCode ADD_INTO_LEDGER_FAILED = RetCode.mark(202590, "add into ledger failed");
    public static final RetCode NOT_ALLOWED_TO_REMOVE_LAST_LINK_NODE = RetCode.mark(202591,"not allowed to remove the last link node, you can try to remove the linking chain");
    public static final RetCode NOT_ALLOWED_TO_ADD_DUPLICATED_LINK_NODE = RetCode.mark(202592,"not allowed to add the duplicated link node");
    public static final RetCode HAS_CREATED_EXPLORER_ALREADY = RetCode.mark(202593,"has created explorer already");
    public static final RetCode HAS_NO_EXPLORER = RetCode.mark(202594,"has no explorer");

    public static final RetCode INVALID_REGION_ID = RetCode.mark(202595, "Invalid region ID");
    public static final RetCode INVALID_FRONT = RetCode.mark(202596, "front donn`t belong to the chain");

    // fabric
    public static final RetCode AGENT_CONN_REFUSED = RetCode.mark(202597, "connect to fabric agent failed");
    public static final RetCode FOUND_NO_NETWORK = RetCode.mark(202598, "found no networks");
    ...
    // fabric
    public static final RetCode EXEC_ERROR = RetCode.mark(502410, "Exec script failed.");
    public static final RetCode DOCKER_COMPOSE_YAML_ERROR = RetCode.mark(502411, "docker-compose yaml not found");
    public static final RetCode EXEC_INVOKE_CHAIN_CODE_ERROR = RetCode.mark(502412, "invoke chain code failed.");
    public static final RetCode EXEC_DEPLOY_CHAIN_CODE_ERROR = RetCode.mark(502413, "deploy chain code failed.");
    public static final RetCode START_NODES_ERROR = RetCode.mark(502414, "Start nodes failed.");
    public static final RetCode CHAIN_CODE_DEPLOYING = RetCode.mark(502415, "chainCode is deploying.");
    public static final RetCode CHAIN_CODE_NOT_APPROVED = RetCode.mark(502416, "chainCode not approved.");
    public static final RetCode CHAIN_CODE_INSTALL_FAILED = RetCode.mark(502417, "chainCode install failed.");

    public static final RetCode CHAIN_CODE_APPROVE_FAILED = RetCode.mark(502418, "chainCode approve failed.");
    public static final RetCode CHAIN_CODE_COMMIT_FAILED = RetCode.mark(502419, "chainCode commit failed.");


    public static final RetCode INVALID_CHAIN_CODE_PACKAGE = RetCode.mark(502500, "invalid chainCode package.");
