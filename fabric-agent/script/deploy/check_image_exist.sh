...
imageFullName="registry.cn-hangzhou.aliyuncs.com/energy/chainfront:v2.0.0"
...
Usage:
    ...
    -i     ImageRepo + / + imageName + tagId, ex: registry.cn-hangzhou.aliyuncs.com/energy/chainfront:v2.0.0
USAGE
    exit ${PARAM_ERROR}
}
