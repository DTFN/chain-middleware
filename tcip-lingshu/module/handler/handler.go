...
import (
	...
	chain_client "chainmaker.org/chainmaker/tcip-lingshu/v2/module/chain-client"
...
func (h *Handler) ChainIdentity(ctx context.Context,
	...
	case common.Version_V1_0_0:
		...
		case common.Operate_SAVE:
			lingshuConfig := conf.LingShuConfig{
				ChainId:  req.BcosConfig.ChainId,
				ChainRid: req.BcosConfig.ChainRid,
			}
			err := chain_config.ChainConfigManager.Save(&lingshuConfig, common.Operate_SAVE)
			if err != nil {
				return &cross_chain.ChainIdentityResponse{
					Code:    common.Code_INTERNAL_ERROR,
					Message: err.Error(),
		...
		case common.Operate_UPDATE:
			...
			err := chain_config.ChainConfigManager.Save(&lingshuConfig, common.Operate_UPDATE)
			if err != nil {
				return &cross_chain.ChainIdentityResponse{
					Code:    common.Code_INTERNAL_ERROR,
					Message: err.Error(),
