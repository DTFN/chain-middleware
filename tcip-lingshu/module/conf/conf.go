...
var (
	...
	ConfigFilePath = "./tcip_lingshu.yml"
	// BaseConf 基础配置
	BaseConf = &BaseConfig{}
	// Config 全剧配置
	Config = &LocalConfig{}
...
func (m *LingShuConfig) Reset()         { *m = LingShuConfig{} }
func (m *LingShuConfig) String() string { return proto.CompactTextString(m) }
func (*LingShuConfig) ProtoMessage()    {}

func (m *LingShuConfig) GetChainId() int64 {
	if m != nil {
		return m.ChainId
	}
	return 0
...
func (m *LingShuConfig) GetState() bool {
	if m != nil {
		return m.State
	}
	return false
...
func (m *LingShuConfig) GetStateMessage() string {
	if m != nil {
...
type ChainIdentityRequest struct {
	...
	EthConfig *LingShuConfig `protobuf:"bytes,7,opt,name=eth_config,json=ethConfig,proto3" json:"eth_config,omitempty"`
	// lingshu配置, lingshu网关专属
	LsConfig *LingShuConfig `protobuf:"bytes,7,opt,name=ls_config,json=lsConfig,proto3" json:"ls_config,omitempty"`
}
