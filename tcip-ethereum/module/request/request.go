...
import (
	...
	"chainmaker.org/chainmaker/tcip-ethereum/v2/module/request/grpcrequest"
	"chainmaker.org/chainmaker/tcip-ethereum/v2/module/request/restrequest"
...
// getTxVerifyType 构造交易验证类型
//
//	@param log
//	@return common.TxVerifyType
...
// getTxVerifyInterface 构造交易验证接口
//
//	@param log
//	@return *common.TxVerifyInterface
...
// getKvsFromKvJsonStr 构造合约参数
//
//	@param kvJsonStr
//	@return []*common.ContractKeyValuePair
//	@return error
func getKvsFromKvJsonStr(kvJsonStr string) ([]*common.ContractKeyValuePair, error) {
	...
	kvs := []*common.ContractKeyValuePair{}
	for k, v := range kvMap {
